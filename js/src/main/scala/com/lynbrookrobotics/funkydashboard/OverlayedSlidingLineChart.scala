...
object OverlayedSlidingLineChart {
  ...
  class Backend($: BackendScope[Props, Option[Chart]]) {
    ...
    def drawChart(c: Chart): Unit = {
      ...
      if (points.nonEmpty) {
        ...
        val data2 = c.data.datasets.asInstanceOf[js.Array[js.Dynamic]](1).data.asInstanceOf[js.Array[js.Dynamic]]
